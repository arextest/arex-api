...
public class CaseDetailMockerProcessor {
  ...
  private static String tryParse(AREXMocker mocker, String body) {
    ...
    if (MockCategoryType.HTTP_CLIENT.equals(mocker.getCategoryType())) {
      ...
      res = JsonUtils.tryParseBase64Json(body);
    }

    return res instanceof String ? (String) res : JsonUtils.toJsonString(res);
  }
}
