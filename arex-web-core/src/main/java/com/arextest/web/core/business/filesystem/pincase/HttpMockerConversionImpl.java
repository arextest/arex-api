 ...
 */
@Slf4j
public abstract class HttpMockerConversionImpl implements MockerConversion {

    protected static final String AND = "&";
    protected static final String EQUAL = "=";
    protected static final String HTTP_METHOD = "HttpMethod";
    protected static final String REQUEST_PATH = "RequestPath";
    protected static final String FORM_DATA_TYPE_TEXT = "text";
    ...
    public FSCaseDto mockerConvertToFsCase(AREXMocker mocker) {
        ...
        try {
            ...
            addressDto.setEndpoint(extractRequestUrl(mocker));
    ...
    abstract String extractRequestUrl(Mocker mocker);
}
