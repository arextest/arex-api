...
public class FileSystemUtils {
  ...
  public MutablePair<Integer, FSNodeDto> findByInfoIdWithIndex(List<FSNodeDto> list,
      String infoId) {
  ...
  public MutablePair<Integer, FSNodeDto> findByNodeNameWithIndex(List<FSNodeDto> list,
      String nodeName) {
    if (list == null || list.size() == 0) {
      return null;
    }
