...
public class StorageCase {
    ...
    public FSCaseDto getViewRecord(String recordId) {
        ...
        ResponseEntity<ViewRecordResponseType> response = HttpUtils.post(storageServiceUrl + STORAGE_VIEW_RECORD_URL,
    ...
    public String getNewRecordId(String recordId) {
        return recordId + DASH + System.currentTimeMillis() + DASH + new Random(System.currentTimeMillis()).nextInt(99);
    }
