...
public class ComparisonEncryptionConfigurationRepositoryImpl
  ...
  public List<ComparisonEncryptionConfiguration> listBy(String appId) {
    ...
    return configComparisonEncryptionCollections.stream()
        .map(ConfigComparisonEncryptionMapper.INSTANCE::dtoFromDao)
  ...
  public boolean update(ComparisonEncryptionConfiguration configuration) {
    ...
    MongoHelper.appendSpecifiedProperties(update, configuration,
        ConfigComparisonEncryptionCollection.Fields.path,
  ...
  public boolean insert(ComparisonEncryptionConfiguration configuration) {
    ...
    Query query = Query.query(Criteria.where(AbstractComparisonDetails.Fields.appId)
        .is(configComparisonEncryptionCollection.getAppId())
        .and(AbstractComparisonDetails.Fields.operationId)
        .is(configComparisonEncryptionCollection.getOperationId())
    ...
    ConfigComparisonEncryptionCollection dao = mongoTemplate.findAndModify(query, update,
        ...
        ConfigComparisonEncryptionCollection.class);
    return dao != null;
  }
  ...
  @Override
  public List<ComparisonEncryptionConfiguration> queryByInterfaceIdAndOperationId(
      String interfaceId,
      String operationId) {
  ...
  public boolean insertList(List<ComparisonEncryptionConfiguration> configurationList) {
    ...
    try {
      ...
      for (ConfigComparisonEncryptionCollection encryptionCollection : encryptionCollections) {
        ...
        Query query = Query.query(Criteria.where(AbstractComparisonDetails.Fields.appId)
            .is(encryptionCollection.getAppId()).and(AbstractComparisonDetails.Fields.operationId)
            .is(encryptionCollection.getOperationId())
            .and(AbstractComparisonDetails.Fields.compareConfigType)
            .is(encryptionCollection.getCompareConfigType())
            .and(AbstractComparisonDetails.Fields.fsInterfaceId)
            .is(encryptionCollection.getFsInterfaceId())
            .and(AbstractComparisonDetails.Fields.dependencyId)
      ...
      LogUtils.error(LOGGER, "encryption insertList failed! list:{}, exception:{}",
          configurationList, e);
      return false;
    }
    return true;
