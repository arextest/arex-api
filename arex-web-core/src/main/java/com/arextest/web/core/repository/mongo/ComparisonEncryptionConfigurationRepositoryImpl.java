...
public class ComparisonEncryptionConfigurationRepositoryImpl
    ...
    public boolean insert(ComparisonEncryptionConfiguration configuration) {
        ...
        Query query = Query.query(Criteria.where(AbstractComparisonDetails.Fields.appId)
            .is(configComparisonEncryptionCollection.getAppId()).and(AbstractComparisonDetails.Fields.operationId)
            ...
            .and(ConfigComparisonEncryptionCollection.Fields.path).is(configComparisonEncryptionCollection.getPath()));
    ...
    @Override
    public List<ComparisonEncryptionConfiguration> queryByInterfaceIdAndOperationId(String interfaceId,
        String operationId) {
        ...
        try {
            ...
            for (ConfigComparisonEncryptionCollection encryptionCollection : encryptionCollections) {
                ...
                Query query = Query.query(Criteria.where(AbstractComparisonDetails.Fields.appId)
                    ...
                    .is(encryptionCollection.getOperationId()).and(AbstractComparisonDetails.Fields.compareConfigType)
                    ...
                    .is(encryptionCollection.getDependencyId()).and(ConfigComparisonEncryptionCollection.Fields.path)
