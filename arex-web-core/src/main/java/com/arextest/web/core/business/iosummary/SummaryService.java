...
public class SummaryService {
  ...
  private CaseSummary.Builder analysis0(CaseSummary.Builder builder,
    ...
    return builder.detail(compareResultDto.getCategoryName(), compareResultDto.getOperationName(),
        category);
  }
}
