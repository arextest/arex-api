...
import com.arextest.web.api.service.controller.handler.GlobalExceptionHandler;
...
public class WebLogAspect {
    ...
    private static final String CONTROLLER_EXCEPTION = GlobalExceptionHandler.class.getName();
  ...
  public Object doAround(ProceedingJoinPoint joinPoint) throws Throwable {
      ...
      try {
          ...
          builder.append("Request        : ").append(serializeRequest(joinPoint.getArgs())).append("\r\n");
          ...
          tags.put(CLASS_METHOD, MessageFormat.format("{0}.{1}",
