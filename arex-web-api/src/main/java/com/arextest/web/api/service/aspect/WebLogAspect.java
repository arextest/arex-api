...
public class WebLogAspect {
    ...
    public Object doAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            builder.append("Class Method   : ").append(joinPoint.getSignature().getDeclaringTypeName()).append(".")
            ...
            tags.put(CLASS_METHOD, MessageFormat.format("{0}.{1}", joinPoint.getSignature().getDeclaringTypeName(),
