...
public class SecneServiceTest {
  ...
  public void before() {
    Query query = Query.query(
        Criteria.where("planItemId").is("planItemId").and("categoryName").is("categoryName")
  ...
  public void testReport() throws Exception {
    ...
    List<DifferenceDto> differenceDtos = repository.queryDifferences("planItemId", "categoryName",
        "operationName");
