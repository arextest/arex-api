...
public enum UnmatchedCategory {
    ...
    MATCHED((byte)0), VALUE_DIFF((byte)1), LEFT_MISSING((byte)2), RIGHT_MISSING((byte)4), UNKNOWN((byte)8);
    ...
    public static UnmatchedCategory computeCategory(CompareResultDto compareResult) {
        switch (compareResult.getDiffResultCode()) {
            ...
            default: {
                ...
                int msgMiss =
                    Optional.ofNullable(msgInfo).map(MsgInfoDto::getMsgMiss).orElse(MsgMissingCode.NO_MISSING);
