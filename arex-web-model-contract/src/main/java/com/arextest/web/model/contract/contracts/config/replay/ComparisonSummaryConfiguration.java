...
public class ComparisonSummaryConfiguration {
  ...
  /**
   * ignore configuration List<String> stores the absolute path of leaf node Set stores multiple
   * leaf nodes
   */
  ...
  /**
   * array collation K: the absolute path of the array node V: a collection of leaf nodes under K,
   * List<String> stores the relative path
   */
  @JsonDeserialize(keyUsing = MapKeyDeserializerUtils.class)
  @JsonSerialize(keyUsing = MapKeySerializerUtils.class)
